...
def extract_Worldpopulationreview():
    ...
    df_social_media.loc[df_social_media['Country Name'] == 'Saudi Arabia', 2023] = 0.793
    df_social_media.loc[df_social_media['Country Name'] == 'Luxembourg', 2023] = 0.621
    df_social_media.loc[df_social_media['Country Name'] == 'Montenegro', 2023] = 0.754
